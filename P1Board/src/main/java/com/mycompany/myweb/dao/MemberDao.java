...
public class MemberDao {
	...
	public int insert(Member member){
		String sql = "insert into member(mid, mpassword, memail) values(?,?,?)";
	...
	public int update(Member member){
		String sql = "update member set mpassword=?, memail=? where mid=?";
		int row = jdbcTemplate.update(
				sql,
				member.getMpassword(),
				member.getMemail(),
	...
	public Member selectByMid(String mid){
		String sql = "select mid, mpassword, memail from member where mid=?";		
	...
	public String selectByMemail(String memail){
		...
		List<String> list = jdbcTemplate.query(sql, new Object[]{memail},
