	...
	<table style="width: 600px;">
		<tr>
			<td>
				...
				<div style="width:120px; height:130px; background-image:url(showPhoto?savedfile=${photoBoard.savedfile}); background-size: 120px 100px; margin: 5px; display: inline-block;">				
